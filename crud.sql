...
--
ALTER TABLE `categoria`
  MODIFY `idCategoria` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;

--
-- AUTO_INCREMENT de la tabla `departamento`
--
ALTER TABLE `departamento`
  MODIFY `idDepartamento` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `empleado`
--
ALTER TABLE `empleado`
  MODIFY `idEmpleado` int(3) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `proveedor`
  MODIFY `idProveedor` int(3) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `puestos`
  MODIFY `job_id` int(3) NOT NULL AUTO_INCREMENT;
...
--
-- Insertar puestos Gerente y Encargado
--
